...
import { TrendingUp, Plus, Search, Filter, Calendar, Eye, CheckCircle } from 'lucide-react';
...
export function AccountsReceivablePage() {
  ...
  const totalReceived = filtered.filter(t => t.status === 'paid').reduce((sum, t) => sum + t.amount, 0);
